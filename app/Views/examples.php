...
<div class="row justify-content-center my-5">
  ...
  <div class="d-none d-md-block col-8 align-self-center text-center">
    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4 w-50" src="<?php echo base_url('assets/img/présentation/lab.jpg'); ?>"
    alt="No result illustration">
  </div>
</div>
<div class="row justify-content-center my-5 txt">
  <div class="col-md-5 col-12 align-self-center text-center justify-content-center">
    ...
    <p class="h4 mb-0 mr-5 ml-5">Aménage3D est un logiciel en libre accès vous permettant de reproduire votre cadre de vie en 2D et 3D. Une multitude de meubles sont à votre dispostion afin de vous aider à recréer votre logement au plus près de la réalité.</p>
  </div>
...
<div class="row justify-content-center my-5 ">
  <div class="col-md-5 col-12 align-self-center text-center justify-content-center txt">
    ...
    <p class="h4 mb-0 mr-5 ml-5">Aménage3D met à disposition un panel de meubles différents et variés. Cette liste permet déjà de créer un environnement propice à l'accueil d'une personne physiquement diminuée ou encore d'adapter un logement déjà existant avec des aides techniques nécessaires au bien être d'une personne. Des mesures automatiques sont mis à votre disposition pour faciliter un maximum l'insertion de nouveaux meubles dans votre environnement.</p>
  </div>
</div>
